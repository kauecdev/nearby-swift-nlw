...
//  nlw-pocket-swift
//
//  Created by Kauê Cavalcante on 12/12/24.
//
...
class DetailsViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        applySideConstraints(to: descriptionLabel)
        applySideConstraints(to: infoStackView)
        applySideConstraints(to: divider)
        applySideConstraints(to: divider2)
        applySideConstraints(to: regulationLabel)
        applySideConstraints(to: couponStackView)
        applySideConstraints(to: qrCodeButton)
    }
    
    private func applySideConstraints(to view: UIView) {
        NSLayoutConstraint.activate([
